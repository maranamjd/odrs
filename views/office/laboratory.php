<div class="container-fluid mt-3 mb-2">
            <div class="d-flex align-items-center p-2 px-3 bg-white border rounded">
                <h5 class="p-2 mr-auto m-0 text-uppercase text-info">College Laboratory</h5>
                ...
                <div class="table-responsive">
                    <table id="tbl_requests" class="table table-striped table-bordered table-hover">
                        ...
                        <tbody>
                            <?php
                            $data = [
                                '2019-00213-MN-1' => ['Dela Curz', 'Juan', 'A', 'BSIT', '2nd', 1],
                                '2016-00513-MN-1' => ['Dela Curz', 'Juan', 'A', 'BSCS', '4th', 2],
                                '2019-00213-MN-1' => ['Dela Curz', 'Juan', 'A', 'BSCS', '1st', 1],
                                '2018-01213-MN-1' => ['Dela Curz', 'Juan', 'A', 'BSIT', '2nd', 3],
                                '2016-00213-MN-1' => ['Dela Curz', 'Juan', 'A', 'BSIT', '4th', 3],
                                '2019-02213-MN-1' => ['Dela Curz', 'Juan', 'A', 'BSCS', '1st', 3],
                                '2015-00113-MN-1' => ['Dela Curz', 'Juan', 'A', 'BSIT', '5th', 1],
                                '2019-00113-MN-1' => ['Dela Curz', 'Juan', 'A', 'BSIT', '1st', 1],
                            ];
                            function action($n) {
                                if ($n == 1) {
