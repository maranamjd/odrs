<div class="container-fluid mt-3 mb-2">
            <div class="d-flex align-items-center p-2 px-3 bg-white border rounded">
                <h5 class="p-2 mr-auto m-0 text-uppercase text-info">Legal</h5>
                ...
                <div class="table-responsive">
                    <table id="tbl_requests" class="table table-striped table-bordered table-hover">
                        ...
                        <tbody>
                            <?php
                            $data = [
                                '2019-00213-MN-1' => ['Dela Curz', 'Juan', 'A', 'BSIT', '1st', 2]
                            ];
                            function action($n) {
                                if ($n == 1) {
                                    return "<span class='btn btn-outline-success btn-sm'>cleared</span>";
                                } else if ($n == 2) {
                                    return "<span class='btn btn-outline-warning btn-sm'>uncleared</span>";
                                } else {
                                    return "<span class='btn btn-outline-warning btn-sm'>uncleared</span>";
