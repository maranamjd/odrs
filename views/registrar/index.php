                ...
                <div class="form-group col-12 my-1">
                  <label for="user" class="mb-1"><small>Employee ID</small></label>
                    <div class="input-group">
                      ...
                      <input class="form-control" id="username" type="text" placeholder="Enter Employee ID" required="required">
                    </div>
                </div>
                <div class="form-group col-12 my-1">
                  ...
                  <div class="input-group">
                    ...
                    <input class="form-control" id="password" type="password" placeholder="Enter Password" required="required">
                  </div>
                </div>
                <div class="form-group col-12 col-lg-4 my-1">
                  <a href="#" id="login" class="btn btn-danger mt-3 w-100">Login</a>
                </div>
              </div>
