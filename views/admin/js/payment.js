$(document).ready(function(){
  ...
  $(document).on('change', '#payment_image', function(){
  ...
  $(document).on('click', '#addPayment', function(){
    ...
    formData.append('desc', $('#payment_description').val());
    formData.append('img', $('#payment_image')[0].files[0]);
    if ($('#payment_description').val() == '' || $('#payment_image').val() == ''){
      swal({
      ...
      swal({
        title: "Are you sure?",
        text: "You are about to add a new Payment Type",
        icon: "warning",
        buttons: true,
        dangerMode: true,
      })
